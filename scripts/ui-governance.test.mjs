...
const knownL3StyleDebt = new Set([
  ...
  "src/l3-molecule/graph/GraphCanvas.tsx: inline style",
  "src/l3-molecule/graph/GraphSummaryPanel.tsx: inline style",
  "src/l3-molecule/graph/GraphTooltip.tsx: inline style",
